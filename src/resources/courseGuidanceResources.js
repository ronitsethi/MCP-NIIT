export const courseGuidanceResources = {
    course_guide_setup_knowledge: {
        ...
        whenThisApplies: "Use this resource when a Learning Advisor needs to understand what course-specific information means, how to read or fill a course guide, or what belongs in setup documentation. This is foundational knowledge needed before creating or modifying any course.",
        keyRules: [
        ...
        escalationPath: "If CI fields are unclear or incomplete, escalate to the course owner. If the course owner is unresponsive, escalate to the DRC (Delivery Resource Coordinator) or Client Executive.",
        requiredInputs: [
    ...
    course_creation_process_knowledge: {
        ...
        domain: "courseGuidance",
        overview: "Step-by-step guidance for creating a new course in the LMS. Covers the template, required fields, approval workflow, and common pitfalls. Designed for new Learning Advisors who need to understand the end-to-end course creation process.",
        whenThisApplies: "Use this resource when a new or existing Learning Advisor needs to create a course for the first time, or needs a refresher on the creation process. Also useful when onboarding new team members.",
        keyRules: [
        ...
        escalationPath: "If the template is unclear, contact the LEM onboarding coordinator. For approval delays, escalate to the course owner's manager.",
    ...
    course_categories_and_fees_knowledge: {
        ...
        domain: "courseGuidance",
        overview: "Explains the course category system (Level-1, Level-2, Level-3, etc.), how categories map to fee structures, and what fees apply for different participant types (internal, external, JVN, OV). Covers external enterprise fees and the rationale behind fee tiers.",
        whenThisApplies: "Use this resource when a Learning Advisor asks about fee definitions, category levels, or how fees are calculated. For specific course fee lookups, use the get_course_fee_info tool.",
        keyRules: [
    ...
    course_details_knowledge: {
        ...
        domain: "courseGuidance",
        overview: "General guidance on finding and interpreting course details such as duration, delivery mode, prerequisites, target audience, and upcoming schedules. This resource helps Learning Advisors know where to look for course information and what each field means.",
        whenThisApplies: "Use this resource when a Learning Advisor needs to understand course attributes or needs guidance on where to find specific course details. For real-time offering schedules and fee data, use the related tools.",
        keyRules: [
