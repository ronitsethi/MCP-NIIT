...
export const enrollmentResources: Record<string, ResourceContent> = {
  learner_enrollment_knowledge: {
    title: "Learner Enrollment Management",
    domain: "enrollments",
    overview:
      "Explains how enrollment works, the enrollment lifecycle, capacity management, waitlist handling, and the relationship between enrollment, offering status, and completion tracking.",
    whenThisApplies:
      "Use this resource when a Learning Advisor asks about enrollment processes, capacity rules, or waitlist management. For real-time enrollment data, use the get_enrollment_status tool.",
    keyRules: [
    ...
    escalationPath:
      "For enrollment system issues, contact the LMS admin team. For capacity increase requests, contact the course owner and venue coordinator.",
