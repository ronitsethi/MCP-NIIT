...
export const servicePolicyResources: Record<string, ResourceContent> = {
  service_requirements_knowledge: {
    title: "LEM Service Requirements & Scope",
    domain: "servicePolicy",
    overview:
      "Explains what 'LEM services required' means, the scope of end-to-end LEM management, and the boundary between activities handled by the LEM team versus those owned by the client or course owner. Covers service activities that should be captured during course setup to avoid scope confusion later.",
    whenThisApplies:
      "Use this resource when a Learning Advisor asks what LEM services include, what falls outside LEM scope, or what activities should be documented during course setup to define the service boundary.",
    keyRules: [
    ...
    escalationPath:
      "If there is a disagreement about service scope, escalate to the DRC or Client Executive for a scope review meeting.",
    requiredInputs: [
