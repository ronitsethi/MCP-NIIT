export const supportResources = {
    system_access_support_knowledge: {
        ...
        domain: "support",
        overview: "Explains common system access issues learners face across Moodle, SharePoint, MS Teams, and Workday, the typical causes, initial troubleshooting steps, and escalation paths. Covers differences in access for internal vs external participants.",
        whenThisApplies: "Use this resource when a Learning Advisor reports a learner access issue and needs guidance on troubleshooting steps or who to escalate to. For creating a support ticket, use the resolve_technical_access_issue tool.",
        keyRules: [
        ...
        escalationPath: "Moodle → LMS Support (Tier-2). SharePoint/Teams → M365 Admin Team. Workday → HR Systems Team. Unknown → General IT Service Desk.",
    ...
    loi_management_knowledge: {
        ...
        domain: "support",
        overview: "Explains the LOI process, common issues (save failures, draft not generating, premature requests), eligibility windows, and troubleshooting guidance. Covers the LOI lifecycle from eligibility to issuance.",
        whenThisApplies: "Use this resource when a Learning Advisor asks about how LOI works, common LOI issues, or eligibility rules. For processing a specific LOI issue, use the process_loi_request tool.",
        keyRules: [
        ...
        escalationPath: "For technical LOI issues: LOI Admin Team. For eligibility disputes: Course Owner (who confirms completion).",
