export const billingResources = {
    billing_and_fee_management_knowledge: {
        ...
        domain: "billing",
        overview: "Explains how billing works for different participant types (internal, external, JVN, OV), cross-entity billing processes, inter-company settlements, cancellation charges, and cost allocation. Covers both the policy framework and the operational process.",
        whenThisApplies: "Use this resource when a Learning Advisor asks about billing policies, who pays, or how cross-entity charges work. For specific course billing lookups, use the related tools.",
        keyRules: [
        ...
        escalationPath: "For billing disputes: Finance Shared Services. For fee exception requests: course owner → finance for joint approval.",
