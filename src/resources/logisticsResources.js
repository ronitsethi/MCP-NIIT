export const logisticsResources = {
    catering_services_knowledge: {
        ...
        domain: "logistics",
        overview: "Explains catering requirements for face-to-face sessions, minimum participant thresholds, location-specific differences, and how catering logistics interact with venue and offering planning.",
        whenThisApplies: "Use this resource when a Learning Advisor asks about catering policies, minimum counts, or how catering works at different locations.",
        keyRules: [
    ...
    go_no_go_policy_knowledge: {
        ...
        domain: "logistics",
        overview: "Explains the go/no-go decision process, SLA timelines, why timing matters for logistics, and the consequences of late decisions. Addresses the common complaint about go/no-go decisions happening too late.",
        whenThisApplies: "Use this resource when a Learning Advisor asks about go/no-go timelines, why decisions are late, or what SLAs apply.",
        keyRules: [
        ...
        escalationPath: "If go/no-go deadline is approaching with no decision: Learning Advisor → Course Owner. If unresponsive: escalate to DRC.",
        relatedTools: [],
        exampleQuestions: [
    ...
    cancellation_policy_knowledge: {
        ...
        domain: "logistics",
        overview: "Explains what happens when learners cancel after the deadline, whether charges still apply, when waivers are possible, and the decision nuances around cancellation timelines.",
        whenThisApplies: "Use this resource when a Learning Advisor asks about cancellation rules, late cancellation charges, or waiver possibilities.",
        keyRules: [
        ...
        escalationPath: "For waiver requests: Learning Advisor → Course Owner + Finance Shared Services. For disputes: formal billing dispute process.",
