export const completionResources = {
    completion_dispute_policy_knowledge: {
        title: "Completion Dispute Policy & Resolution Process",
        domain: "complianceOrCompletion",
        overview: "Explains how completion disputes are handled, who has authority to make pass/fail decisions, what evidence is used, and the role of the Learning Advisor in the dispute process. Covers the distinction between LEM's administrative role and the course owner's decision authority.",
        whenThisApplies: "Use this resource when a Learning Advisor asks about completion disputes, how pass/fail decisions are made, or what to do when a learner challenges their completion status. For fetching attendance evidence, use the get_attendance_evidence tool.",
        keyRules: [
        ...
        escalationPath: "Learning Advisor → Course Owner (for decision). If course owner is unresponsive, escalate to DRC. If learner disagrees with decision, formal learning grievance process.",
    ...
    attendance_and_completion_knowledge: {
        ...
        domain: "complianceOrCompletion",
        overview: "Explains how attendance is tracked, how completion status is determined, and the relationship between attendance, assessment, and final completion status.",
        whenThisApplies: "Use this resource when a Learning Advisor needs to understand attendance tracking methods or completion determination logic. For fetching specific attendance records, use the get_attendance_evidence tool.",
        keyRules: [
    ...
    aar_sessions_knowledge: {
        ...
        domain: "postDelivery",
        overview: "Explains what happens in after-action review sessions, what is discussed, who participates, and when LEM involvement is needed. AARs are post-delivery reviews focused on improving future offerings.",
        whenThisApplies: "Use this resource when a Learning Advisor asks about AAR sessions, what happens in them, or whether they need to participate.",
        keyRules: [
