export const hostingResources = {
    hosting_services_knowledge: {
        title: "Hosting Services: Full vs Light Hosting",
        domain: "hosting",
        overview: "Explains the two hosting models available for course delivery: Full Hosting and Light Hosting. Covers support levels, session-duration implications, when each model is appropriate, and decision criteria for Learning Advisors when recommending hosting options to course owners.",
        whenThisApplies: "Use this resource when a Learning Advisor asks about hosting models, the difference between full and light hosting, or needs guidance on which hosting option to recommend for a specific course.",
        keyRules: [
        ...
        escalationPath: "If a course owner is unsure which model to choose, the Learning Advisor should schedule a brief call with the LEM hosting coordinator to walk through the options.",
        requiredInputs: [
            "Session duration",
