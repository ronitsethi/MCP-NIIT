...
export function registerAttendanceTools(server: McpServer) {
  server.tool(
    ...
    `Retrieve attendance records and evidence relevant to completion disputes for a specific learner and offering.
...
- "Pull attendance evidence for dispute review"`,
    GetAttendanceEvidenceSchema.shape,
    async (input) => {
