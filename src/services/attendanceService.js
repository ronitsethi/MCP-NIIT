...
export async function getAttendanceEvidence(input) {
    const result = await query("SELECT * FROM attendance WHERE user_id = $1 AND offering_id = $2", [input.userId, input.offeringId]);
