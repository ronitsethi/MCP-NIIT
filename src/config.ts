...
export const SERVER_CONFIG = {
  ...
  version: "1.0.0",
  description:
    "MCP Server for Learning Advisor AI Avatar — provides tools for dynamic operations and resources for static/policy knowledge across learning management domains.",
} as const;
